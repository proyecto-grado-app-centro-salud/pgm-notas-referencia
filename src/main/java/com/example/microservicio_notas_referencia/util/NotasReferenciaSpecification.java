package com.example.microservicio_notas_referencia.util;
...
public class NotasReferenciaSpecification {
       public static Specification obtenerNotasReferenciaPorParametros(Date minDate, Date maxDate,
            String ciPaciente, String nombrePaciente, String nombreMedico, String nombreEspecialidad,
            String diagnosticoPresuntivo) {
          try {
            return (root,query,builder) -> { 
                Join<NotasReferenciaEntity, HistoriaClinicaEntity> historiaClinicaJoin = root.join("historiaClinica");
     ...
     public static Specification obtenerNotasReferenciaDePacientePorParametros(int idPaciente,Date minDate, Date maxDate,
